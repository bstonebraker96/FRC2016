...
public class visionRobot extends SampleRobot {
		...
		//Constants
		NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(56, 85);	//Default hue range for yellow tote
		NIVision.Range TOTE_SAT_RANGE = new NIVision.Range(67, 255);	//Default saturation range for yellow tote
		NIVision.Range TOTE_VAL_RANGE = new NIVision.Range(49, 200);	//Default value range for yellow tote
		double AREA_MINIMUM = 0.5; //Default Area minimum for particle as a percentage of total image area
		double LONG_RATIO = 1.6; //Tote long side = 26.9 / Tote height = 12.1 = 2.22
		double SHORT_RATIO = 1.0; //Tote short side = 16.9 / Tote height = 12.1 = 1.4
